 ...
 */
public class ScoreCreatedEvent {
    ...
    public ScoreCreatedEvent(ScoreID scoreID, TeachingClassScoreRecordID teachingClassScoreRecordID, StudentID studentID, CourseID courseID,String termID, HashMap<ScoreTypeEnum, String> scores) {
